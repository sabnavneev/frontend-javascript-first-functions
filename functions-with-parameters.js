...
console.log('Hoi ' + greeter('Jan'));
console.log('Hoi ' + greeter('Kees'));
...
console.log(merge('abra', 'abracadabra'));
...
/* Bonus opdracht  */
// Schrijf een functie genaamd createDetailString, die een object met de properties firstName, firstName en profession verwacht en een zin teruggeeft
// ---- Verwachte uitkomsten:
